      ...
      <form action={login}>
        <FieldGroup>
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            <FieldDescription>
              Don&apos;t have an account? <a href="/signup" className="text-amber-600 hover:text-amber-500 font-medium">Sign up</a>
            </FieldDescription>
          </div>
          <Field>
          ...
          <Field>
            <div className="flex items-center">
              ...
              <a
                href="#"
                className="ml-auto text-sm text-neutral-500 hover:underline underline-offset-4"
              >
          ...
          <Field>
            <Button type="submit" className="w-full bg-gradient-to-r from-amber-400 to-yellow-500 text-white hover:opacity-90 shadow-md shadow-amber-200/50 border-0">Login</Button>
          </Field>
