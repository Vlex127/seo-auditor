      ...
      <form action={signup}>
        <FieldGroup>
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            <h1 className="text-xl font-bold">Welcome to SEO-Auditor</h1>
            <FieldDescription>
              Already have an account? <a href="/login" className="text-amber-600 hover:text-amber-500 font-medium">Sign in</a>
            </FieldDescription>
          </div>
          <Field>
          ...
          {message && (
            <p className="text-sm font-medium text-amber-600 text-center">{message}</p>
          )}
          <Field>
            <Button type="submit" className="w-full bg-gradient-to-r from-amber-400 to-yellow-500 text-white hover:opacity-90 shadow-md shadow-amber-200/50 border-0">Create Account</Button>
          </Field>
